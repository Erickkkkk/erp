...
<div style="width:960;margin:0 auto">
	<div class="cell auto-size padding20 bg-white" id="cell-content">
		<h1 class="text-light">
			新增角色 <span class="mif-user-plus place-right"></span>
		</h1>
		<hr class="thin bg-grayLighter">
		<button class="button success" onclick="addrolesubmit()">
			...
			<tr>
				...
				<td>
					<div class="input-control textarea">
						<textarea id="roledescription" style="width:10.875rem;height:60;font-family:'宋体'"></textarea>
					</div>
				</td>
			</tr>
			<tr>
	...
	<script language="javascript" type="text/javascript"
		src="<%=basePath%>js/myjs/addrole.js"></script>

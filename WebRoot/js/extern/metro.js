...
$.widget( "metro.wizard2" , {
    ...
    _createActionBar: function(){
        ...
        //btn_help = $("<button/>").html(o.buttonLabels.help).addClass('button square-button medium-button wiz-btn-help place-left').appendTo(bar);
        btn_finish = $("<button/>").html(o.buttonLabels.finish).addClass('button square-button medium-button wiz-btn-finish place-right').appendTo(bar);
        btn_next = $("<button/>").html(o.buttonLabels.next).addClass('button square-button medium-button wiz-btn-next place-right').appendTo(bar);
        btn_prev = $("<button/>").html(o.buttonLabels.prev).addClass('button square-button medium-button wiz-btn-prev place-right').appendTo(bar);

...
<body>
						...
						<div class="text-small padding20 bg-grayLighter"
							...
							<div class="clear-float">
								<div class="place-left">
									...
									<table>
										<tr>
											<td><input type="hidden" value="${tr.id}" id="iddefault">
											<input type="hidden" value="${tr.username}" id="usernamedefault">
											<span class="mif-meter fg-green"
												style="margin-bottom:5"></span> 出差事由:&nbsp;</td>
											<td colspan="3"><div
													class="input-control text full-size" data-role="input">
													<input type="text" id="travelreason" value="${tr.travelreason}">
										...
										<tr style="height:100">
											...
											<td><div class="input-control text full-size"
													...
													data-locale="zhCN">
													<input type="text" id="startdate" value="${tr.startdate}">
													<button class="button">
											...
											<td><div class="input-control text full-size"
													data-role="datepicker" data-week-start="1"
													data-locale="zhCN">
													<input type="text" id="enddate" value="${tr.enddate}">
													<button class="button">
														<span class="mif-calendar"></span>
													</button>
												</div>
										...
										<tr style="height:50">
											...
											<td><div class="input-control text full-size"
													data-role="input">
													<input type="text" id="startplace" value="${tr.startplace}">
													<button class="button helper-button clear">
														<span class="mif-cross"></span>
													</button>
												</div>
											...
											<td><div class="input-control text full-size"
													data-role="input">
													<input type="text" id="endplace" value="${tr.endplace}">
													<button class="button helper-button clear">
														<span class="mif-cross"></span>
													</button>
												</div>
					...
					<div class="step-content">
						...
						<div class="text padding20 bg-grayLighter" style="height:420">
							...
							<div>
								<table>
									<tr style="height:50">
										<td><input id="leavevehicledefault" type="hidden" value="${tr.leavevehicle}"><label style="color:green"><span
												class="mif-arrow-right mif-2x fg-green"></span> 去时</label>
										</td>
										<td><input id="returnvehicledefault" type="hidden" value="${tr.returnvehicle}"><label style="color:red"><span
									...
									<tr>
										<td><span style="color:red">￥</span>
											<div class="input-control modern text">
												<input type="text" id="leavevehiclecost" value="${tr.leavevehiclecost}"> <span
										...
										<td><span style="color:red">￥</span>
											<div class="input-control modern text">
												<input type="text" id="returnvehiclecost" value="${tr.returnvehiclecost}"> <span
					...
					<div class="step-content">
						...
						<div class="text padding20 bg-grayLighter" style="height:420">
							...
							<div>
								<table>
									<tr>
									<td><input type="hidden" id="accommodationtypedefault" value="${tr.accommodationtype}">
									<input type="hidden" id="accommodationremarkdefault" value="${tr.accommodationremark}">
									<input type="hidden" id="accommodationcostdefault" value="${tr.accommodationcost}"><label class="input-control radio block"> <input
					...
					<div class="step-content">
						...
						<div class="text padding20 bg-grayLighter" style="height:420">
							...
							<div>
								<table>
									<tr>
										<td><input type="hidden" id="subsidytypedefault" value="${tr.subsidytype}"><span class="mif-home fg-green"
										...
										<td><div class="input-control text" style="width:80">
												<input id="subsidyperday" value="${tr.subsidyperday}" type="text" disabled>
											</div>元/天</td>
										<td>，共出差
											<div class="input-control text" style="width:80">
												<input id="subsidydays" value="${tr.subsidydays}" type="text" disabled>
											</div>天</td>
										<td>，合计
											<div class="input-control text" style="width:120">
												<input id="subsidysum" value="${tr.subsidysum}" type="text" disabled>
											</div>元</td>
									</tr>
									<tr>
								...
								<table>
									<tr>
										...
										<td><div class="input-control text" data-role="input">
												<input id="othercontent"  placeholder="填写费用名称" type="text" value="${tr.othercontent}">
												<button class="button helper-button clear">
													<span class="mif-cross"></span>
												</button>
											</div>
										...
										<td><span style="color:red">￥</span>
										<div class="input-control modern text">
												<input type="text" id="othercost" value="${tr.othercost}"> <span
	...
	<script>
		$(function() {
			$(":radio[name='r1'][value='"+$("#leavevehicledefault").val()+"']").attr("checked",true);
			$(":radio[name='r2'][value='"+$("#returnvehicledefault").val()+"']").attr("checked",true);
			$(":radio[name='r3'][value='"+$("#accommodationtypedefault").val()+"']").attr("checked",true);
			if($("#accommodationtypedefault").val()=="包含他人费用"){
				$("#allaccommodation").show();
				$("#allaccommodationcost").val($("#accommodationcostdefault").val());
				$("#allaccommodationremark").val($("#accommodationremarkdefault").val());
			}
			if($("#accommodationtypedefault").val()=="他人统一支付"){
				$("#otheraccommodation").show();
				$("#otheraccommodationremark").val($("#accommodationremarkdefault").val());
			}
			if($("#accommodationtypedefault").val()=="仅含个人费用"){
				$("#personalaccommodation").show();
				$("#personalaccommodationcost").val($("#accommodationcostdefault").val());
			}
			$("#subsidytype").val($("#subsidytypedefault").val());
					...
					.click(
							function() {
								...
								$("#travelreimbersesubmit").click(function(){
									$.ajax({
										type:'post',
										url:basePath+'travel/updateTravelReimburse.do',
										data:{
											'id':$("#iddefault").val(),
										...
										success:function(data){
											if(data==='true'){
												div.remove();
												dialog.close();
												if(loginusername!=$("#usernamedefault").val()){window.location.href=basePath+'travel/queryAllTravelReimburse.do';}
												else{window.location.href=basePath+'travel/queryTravelReimberse.do?username='+loginusername;}
											}else{
												alert("编辑失败！ ");
												return;
											}
